...
<template>
	<div class="wscn-http404-container">
		<div class="wscn-http404">
			<div class="pic-404">
				<img class="pic-404__parent" :src="noFound" alt="404" />
				<img class="pic-404__child left" :src="noFoundCloud" alt="404" />
				<img class="pic-404__child mid" :src="noFoundCloud" alt="404" />
				<img class="pic-404__child right" :src="noFoundCloud" alt="404" />
			</div>
			<div class="bullshit">
